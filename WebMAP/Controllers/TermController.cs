...
namespace WebMAP.Controllers
{
    public class TermController : Controller
    {
        ...
        public ActionResult List()
        {
            ...
            var model = ts.GetMany(null, null, "project").ToList();
        ...
        public ActionResult AddTermToResource(int id, string firstname, string lastname, double? salary, string mail)
        {
            ...
            t.resource = new resource() { firstName = firstname, lastName = lastname, idUser = id, salary = salary, email = mail };
        ...
        public ActionResult GetEndDate(int idUser, string dateStart, int numberofDaysTerm)
        {
            try
            {
                ...
                {
                    var result = ApiFactory.CalculateEndTerm(idUser, numberofDaysTerm, start);
                    return Json(result.dateEnd.HasValue ? result.dateEnd.Value.ToString("yyyy-MM-dd") : "", JsonRequestBehavior.AllowGet);
                }
                else
                {
